"""Tests for the RemoteTTS entity."""
...
from homeassistant.components.remotetts import ApiError
...
async def mock_config_entry_setup(
    ...
    with patch(
        "homeassistant.components.remotetts.RemoteTTSClient", return_value=client_mock
    ):
...
async def test_tts_service_speak(
    ...
    tts_entity._client.synthesize.reset_mock()
    ...
    tts_entity._client.synthesize.assert_called_once_with(
...
async def test_tts_service_speak_error(
    ...
    tts_entity = hass.data[tts.DOMAIN].get_entity(service_data[ATTR_ENTITY_ID])
    tts_entity._client.synthesize.reset_mock()
    tts_entity._client.synthesize.side_effect = ApiError
